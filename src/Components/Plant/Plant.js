  ...
  return(
    <main className='plant-details-container'>
      ...
      <section className='planting-care-container'>
        <h1 className='planting-care-title'>{`Plant Guide for ${plant zone data}`}</h1>
        ...
        <p className='sun-duration'>{`Sun: ${sun data}`}</p>
        <p className='weekly-water'>{`Weekly Water: ${water data}`}</p>
